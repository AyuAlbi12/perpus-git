                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="notelp" name="notelp" aria-describedby="usernameHelp"
                                            placeholder="No Telp" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="status" name="status" aria-describedby="usernameHelp"
                                            placeholder="Email" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="level" name="level" aria-describedby="usernameHelp"
                                            placeholder="Email" autocomplete="off">
                                    </div>
