...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if($title == 'Buku' or $title == 'Anggota' or $title == 'Kategori'): ?>
            <li class="nav-item active">
                <?php else: ?>
            <li class="nav-item">
                <?php endif; ?>
            ...
            <?php if($this->session->userdata('level') == 'Administrasi' || $this->session->userdata('level') == 'Anggota'): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>laporan/peminjaman">laporan Peminjaman</a>
                        <a class="collapse-item active" href="<?= base_url() ?>peminjaman">Peminjaman Buku</a>
                    </div>
