        ...
        <div class="d-sm-flex  justify-content-between mb-0">
            <div class="col-lg-8 mb-4">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-4"> 
                                ...
                                <div class="form-group"><label>Ulasan</label>
                                    <input class="form-control" name="ulasan" type="text" placeholder="">
                                </div>
                            </div>
                        </div>
             ...
             <div class="col-lg-4 mb-4"> 
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    <div class="card-header py-3 bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">Sampul Foto</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/icon/book.png" id="outputImg" width="100"
                                    maxheight="300">
                            </div>
                            <div id="pdf">
